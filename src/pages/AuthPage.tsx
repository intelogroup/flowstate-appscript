      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <div className="mt-4 flex items-center space-x-2 text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
              <AlertCircle className="w-4 h-4 text-blue-600" />
              <span>Google authentication is required for Gmail and Drive access</span>
            </div>
          </CardContent>
        </Card>
      </div>
